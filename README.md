...
面向 Windows 的开发环境诊断器与安全操作面板。当前版本：**1.5.1 Final Stable**。
...
- `tauri\src-tauri\target\release\bundle\nsis\DevEnv Manager_1.5.1_x64-setup.exe`
- `tauri\src-tauri\target\release\bundle\msi\DevEnv Manager_1.5.1_x64_en-US.msi`
